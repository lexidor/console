...
final class HelpScreen {
    ...
    public function render(): string {
        ...
        return Str\join($retval, Output::LF.Output::LF);
    }
    ...
    protected function renderHeading(): string {
        ...
        return Str\join($retval, Output::LF);
    }
    ...
    protected function renderSection<T as Input\Definition\IDefinition>(
        ...
        return Str\join($output, Output::LF);
    }
    ...
    protected function renderUsage(): string {
        ...
        if ($this->command is nonnull) {
            ...
            foreach ($command->getFlags() as $argument) {
                ...
                if ($argument->getAlias() !== '') {
                    $arg .= "|".
                        $argument->getFormattedName($argument->getAlias());
                }
    ...
    public function setCommands(
        KeyedContainer<string, Command> $commands,
    ): this {
